      ...
      <div className="mb-2">
        ...
        <div className="flex space-x-2">
          <button
            ...
            className={`flex-1  rounded-full font-medium transition-all duration-300 ${language === 'fa' ? 'text-sm font-lahzeh py-4 ' : 'py-3'} ${activeGroup === 'group02'
          ...
          >
            {currentTexts.group02}
          </button>

          <button
            onClick={() => setActiveGroup('group01')}
            className={`flex-1 py-3 rounded-full font-medium transition-all duration-300 ${language === 'fa' ? 'text-sm font-lahzeh py-4' : 'py-3'} ${activeGroup === 'group01'
